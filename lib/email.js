...
export async function sendBookingEmails({ clientName, clientEmail, clientPhone, sessionType, slotStart, slotEnd, reason }) {
  ...
  var clientHtml = [
    ...
    '<strong>65 Tiong Poh Road #02-26</strong><br>Tiong Bahru Estate, Singapore 160065<br>',
    '<span style="color:#8a8478; font-size:0.9em;">Havelock MRT / Near Tiong Bahru Market</span>',
    '</div>',
    '<p style="font-size:0.9em; color:#8a8478;">Please aim to arrive 5–10 minutes early if this is your first time visiting this location. Cancellations less than 48 hours before the session are charged in full, so please let me know as soon as you need to change this appointment.</p>',
    ...
    '<p style="color:#8a8478; font-size:0.85em; margin-top:1rem;">Nicole Chew-Helbig, PhD<br>Psychotherapist</p>',
    '</div>',
