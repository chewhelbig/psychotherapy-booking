...
// ─────────────────────────────────────────────────────────────
// Practice address — Tiong Bahru (office moved 22 June 2026).
// ─────────────────────────────────────────────────────────────
function getPracticeAddress() {
  return {
    html: '<strong>65 Tiong Poh Road #02-26</strong><br>Singapore 160065',
    text: '65 Tiong Poh Road #02-26, Singapore 160065',
  };
}
...
export async function sendBookingEmails({ clientName, clientEmail, clientPhone, sessionType, slotStart, slotEnd, reason }) {
  ...
  // Practice address (Tiong Bahru)
  var address = getPracticeAddress();
  ...
  // Email to Nicole — with address box + WhatsApp click-to-send link
  var nicoleHtml = [
    '<div style="font-family:sans-serif; max-width:500px; margin:0 auto; color:#2a2822;">',
    '<div style="background:#3d6b50; height:4px;"></div>',
    ...
    '</div>',
    '<div style="background:#f0e8c8; border-left:3px solid #3d6b50; padding:0.8rem 1rem; margin-bottom:1rem; border-radius:2px; font-size:14px;">',
    address.html,
    '</div>',
