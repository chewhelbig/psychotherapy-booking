...
function getAuth() {
  ...
  // If key still doesn't start with the PEM header, something is wrong
  if (!key.startsWith('-----BEGIN')) {
    console.error('GOOGLE_PRIVATE_KEY does not start with PEM header. First 50 chars:', key.substring(0, 50));
  }
